        ...
        public static void SeedDatabase(this IServiceProvider serviceProvider)
        {
            ...
            if (!context.Users.Any())
            {
                ...
                context.Users.AddRange(
                    ...
                    new User { Email = "bank@ccms.local", PasswordHash = passwordHash, FullName = "Bank Officer", Role = UserRole.BankOfficer, Organization = "Bank" }
                );
            }
            ...
            if (!context.BankCustomers.Any())
            {
                context.BankCustomers.AddRange(
                    new BankCustomer { AccountNumber = "1234567890", Aadhaar = "123456789012", PAN = "ABCDE1234F", Balance = 50000.00m, AccountStatus = "Active", BankName = "Test Bank" },
                    new BankCustomer { AccountNumber = "0987654321", Aadhaar = "210987654321", PAN = "FGHIJ5678K", Balance = 1500.50m, AccountStatus = "Dormant", BankName = "Test Bank" }
                );
            }
            ...
            if (!context.Cases.Any())
            {
                context.Cases.AddRange(
                    new Case
                    {
                        ...
                        DefendantAccountNumber = "1234567890",
                        DefendantBankName = "Test Bank",
                        DefendantAadhaar = "123456789012",
                    ...
                    new Case
                    {
                        ...
                        DefendantAccountNumber = "0987654321",
                        DefendantBankName = "Test Bank",
                        DefendantAadhaar = "210987654321",
                        DefendantPAN = "FGHIJ5678K",
