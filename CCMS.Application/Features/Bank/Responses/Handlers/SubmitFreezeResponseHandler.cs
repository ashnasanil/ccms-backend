...
{
    public class SubmitFreezeResponseHandler : IRequestHandler<SubmitFreezeResponseCommand>
    {
        private readonly ICaseRepository _caseRepository;
        private readonly ICurrentUserService _currentUserService;

        public SubmitFreezeResponseHandler(ICaseRepository caseRepository, ICurrentUserService currentUserService)
        {
            _caseRepository = caseRepository;
            _currentUserService = currentUserService;
        }

        public async Task Handle(SubmitFreezeResponseCommand request, CancellationToken cancellationToken)
        {
            ...
            @case.CaseResponse = new CaseResponse
            {
                ...
                FreezeAmount = request.FreezeAmount,
